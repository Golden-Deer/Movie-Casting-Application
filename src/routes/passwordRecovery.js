        ...
        return(
            <div className='center'>
                ...
                <table class='center'>
                    ...
                    <tr class='center'><td class='center'><input name="email" type="email" placeholder="Email" form='recovery_form'/></td></tr>
                    <tr class='center' style={{marginTop: 25 + 'px'}}><button class="btn btn-primary" variant="primary" form='recovery_form'>Send Email</button></tr>
                    <tr class='center' style={{marginTop: 20 + 'px'}}><p>{this.state.indicator}</p></tr>
