    ...
    render(){
        return(
            ...
            {this.props.field == 'Description' ? 
                <tr class='center'>
                    <textarea value={this.props.newValue} cols='41' rows='4' onChange={(e)=>this.editField(e, this.props.field, this.props.originalValue)} style={{marginTop: 40 + 'px'}}></textarea>
                </tr>
                :
                <tr class='center'>
                    <input value={this.props.newValue} onChange={(e)=>this.editField(e, this.props.field, this.props.originalValue)} style={{marginTop: 50 + 'px'}}></input>
                </tr>
            }
            <tr class='center'>
